        ...
        <div className="max-w-3xl mx-auto text-center space-y-8">
          ...
          <div className="flex flex-wrap items-center justify-center gap-6 pt-8 animate-fade-up stagger-3">
            <div className="flex items-center gap-2 text-sm text-primary-foreground/70">
              ...
              <span>5.0 Rating (500+ Reviews)</span>
            </div>
            <div className="hidden sm:block w-px h-4 bg-primary-foreground/30" />
            <div className="text-sm text-primary-foreground/70">40+ Years Experience</div>
            <div className="hidden sm:block w-px h-4 bg-primary-foreground/30" />
            <div className="text-sm text-primary-foreground/70">Trusted by Generations</div>
          </div>
        </div>
      </div>
